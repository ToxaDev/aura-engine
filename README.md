...
|---|---|---|---|---|
| **Compact** | 5k taps | every multiplier — FS2 to FS16 | ~7 MB | [**Download**](https://github.com/ToxaDev/aura-engine/releases/download/v1.2.8/aura-engine-v1.2.8-bundle-5k-windows-x64.zip) |
| **Starter** | 1M taps | every multiplier — FS2 to FS16 | ~134 MB | [**Download**](https://github.com/ToxaDev/aura-engine/releases/download/v1.2.8/aura-engine-v1.2.8-bundle-1M-windows-x64.zip) |
| **Standard** — *start here* | 10M taps | FS8 — 352.8 / 384 kHz | ~326 MB | [**Download**](https://github.com/ToxaDev/aura-engine/releases/download/v1.2.8/aura-engine-v1.2.8-bundle-10M-windows-x64.zip) |
| **Reference** | 30M taps | FS8 — 352.8 / 384 kHz | ~966 MB | [**Download**](https://github.com/ToxaDev/aura-engine/releases/download/v1.2.8/aura-engine-v1.2.8-bundle-30M-windows-x64.zip) |
...
start. 5k is the whole app in a few megabytes, 1M carries every multiplier in a
download small enough for a phone tether, and 30M is the longest filter the
engine designs.
...
|---|---|---|
| [`aura-engine-v1.2.8-windows-x64.zip`](https://github.com/ToxaDev/aura-engine/releases/download/v1.2.8/aura-engine-v1.2.8-windows-x64.zip) | The app alone. Needs filters from somewhere. | ~6 MB |
...
2. Set the **FS multiplier** (FS2–FS16) and **filter resolution** (5k–30M taps).
3. Optionally switch on **Subsonic Filter**, **Adaptive Apodizer**,
   **Polyphase FIR Resampling**, **Hybrid-Phase Blending** (the lit rows under
   Advanced DSP), or **Hardware GPU Acceleration**.
...
| **Subsonic Filter** (20/15/10 Hz) | Optional, off by default. A linear-phase FIR high-pass at the source rate, right after DC blocking: flat within 0.01 dB from the corner up, at least 100 dB down from half the corner to DC. Click the chip on the row to change the corner. It is there for speakers — infrasound and slow drift a disc can carry, which removing the DC offset does not touch — not as a sound improvement (tag `SUB20` / `SUB15` / `SUB10`). With Hybrid-Phase on, the switch points follow the filtered signal. |
