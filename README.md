...
|---|---|---|---|---|
| **Compact** | 5k taps | every multiplier — FS2 to FS16 | ~7 MB | [**Download**](https://github.com/ToxaDev/aura-engine/releases/download/v1.2.9/aura-engine-v1.2.9-bundle-5k-windows-x64.zip) |
| **Starter** | 1M taps | every multiplier — FS2 to FS16 | ~134 MB | [**Download**](https://github.com/ToxaDev/aura-engine/releases/download/v1.2.9/aura-engine-v1.2.9-bundle-1M-windows-x64.zip) |
| **Standard** — *start here* | 10M taps | FS8 — 352.8 / 384 kHz | ~326 MB | [**Download**](https://github.com/ToxaDev/aura-engine/releases/download/v1.2.9/aura-engine-v1.2.9-bundle-10M-windows-x64.zip) |
| **Reference** | 30M taps | FS8 — 352.8 / 384 kHz | ~966 MB | [**Download**](https://github.com/ToxaDev/aura-engine/releases/download/v1.2.9/aura-engine-v1.2.9-bundle-30M-windows-x64.zip) |
...
|---|---|---|
| [`aura-engine-v1.2.9-windows-x64.zip`](https://github.com/ToxaDev/aura-engine/releases/download/v1.2.9/aura-engine-v1.2.9-windows-x64.zip) | The app alone. Needs filters from somewhere. | ~6 MB |
